...
import vipProtectionPhoto from "./assets/vip-protection.png";
import residentialPhoto from "./assets/residential-estates.png";
...
const FontStyle = () => (
  <style>{`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @keyframes scanLine { 0% { left: 0%; opacity: 0; } 8% { opacity: 1; } 92% { opacity: 1; } 100% { left: 100%; opacity: 0; } }
      ...
      <div className="relative max-w-7xl mx-auto px-6 flex items-center justify-between transition-all duration-300" style={{ paddingTop: scrolled ? "10px" : "16px", paddingBottom: scrolled ? "10px" : "16px" }}>
        <button onClick={() => { navigate("/"); setTimeout(() => scrollTo("hero"), 100); }}
          ...
          style={{
            ...
            padding: (!scrolled && location.pathname === "/") ? "6px 12px" : "0",
            boxShadow: (!scrolled && location.pathname === "/") ? "0 2px 12px rgba(0,0,0,0.15)" : "none"
          }}>
          <img src="/logo.png" alt="CHESTON Security" className="transition-all duration-300" style={{ height: scrolled ? "64px" : "76px", objectFit: "contain" }} />
        </button>
...
function Hero() {
  const navigate = useNavigate();
  const heroImages = [personnelPhoto, vipProtectionPhoto, residentialPhoto];
  ...
  return (
    <section id="hero" className="relative flex flex-col overflow-hidden"
      style={{ height: "100svh", background: "linear-gradient(180deg,#0f1216 0%,#14181d 100%)" }}>

      {/* Gold hairline frame */}
      <div className="absolute inset-3 sm:inset-6 border pointer-events-none"
        style={{ borderColor: "rgba(201,151,63,0.22)" }} />
      <div className="absolute top-3 left-3 sm:top-6 sm:left-6 w-6 h-6 sm:w-8 sm:h-8 border-t border-l pointer-events-none"
        style={{ borderColor: "#c9973f" }} />
      <div className="absolute bottom-3 right-3 sm:bottom-6 sm:right-6 w-6 h-6 sm:w-8 sm:h-8 border-b border-r pointer-events-none"
        style={{ borderColor: "#c9973f" }} />

      {/* Main Content */}
      <div className="relative flex-1 flex items-center min-h-0 pt-24 sm:pt-0">
        <div className="w-full max-w-6xl mx-auto px-6 sm:px-10 grid lg:grid-cols-[1.3fr_0.7fr] gap-10 items-center">

          <div>
            {/* Eyebrow */}
            <div className="animate-fadeUp flex items-center gap-3 mb-4 sm:mb-6">
              <div className="h-px w-8 sm:w-10" style={{ background: "#c9973f" }} />
              <span className="text-[10px] sm:text-xs font-semibold tracking-[0.2em] uppercase" style={{ color: "#c9973f" }}>
                Cheston Security Services Limited
              </span>
            </div>

            {/* Heading */}
            <h1 className="animate-fadeUp delay-100 text-4xl sm:text-6xl lg:text-7xl leading-[1.08] text-white mb-5 sm:mb-7"
              style={{ letterSpacing: "-0.02em", fontFamily: "'Playfair Display',serif", fontWeight: 700 }}>
              Protection built<br />
              <span style={{ fontWeight: 500 }}>on discipline,</span><br />
              <span style={{
                color: "#c9973f",
                fontStyle: "italic",
                fontWeight: 500,
                ...
                <span style={{
                  ...
                  width: "100%",
                  height: "2px",
                  background: "linear-gradient(90deg, #c9973f 0%, transparent 90%)"
                }} />
              </span>
            </h1>

            {/* Subtext */}
            <p className="animate-fadeUp delay-200 text-sm sm:text-lg text-white/60 leading-relaxed mb-6 sm:mb-9 max-w-lg">
              Kenya's trusted name in guarding, armed response, and executive protection —
              led by senior officers with career backgrounds in the Disciplined Forces.
            </p>

            {/* Buttons */}
            <div className="animate-fadeUp delay-300 flex flex-wrap gap-3">
              <button onClick={() => navigate("/contact")}
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-7 py-3 sm:py-4 font-bold text-black text-xs sm:text-sm tracking-wide hover:-translate-y-0.5 transition-all"
                style={{ background: "#c9973f" }}>
                Request Protection <ArrowRight className="w-4 h-4" />
              </button>
              <button onClick={() => navigate("/services")}
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-7 py-3 sm:py-4 font-bold text-white text-xs sm:text-sm tracking-wide border hover:-translate-y-0.5 transition-all"
                style={{ borderColor: "rgba(255,255,255,0.25)" }}>
                <Play className="w-3.5 h-3.5" style={{ color: "#c9973f" }} /> View Services
              </button>
            </div>

            {/* Compact photo strip — mobile only */}
            <div className="animate-fadeIn delay-200 relative mt-6 lg:hidden" style={{ padding: "6px", border: "1px solid rgba(201,151,63,0.35)" }}>
              <div className="relative overflow-hidden rounded-sm" style={{ aspectRatio: "16/9" }}>
                <img src={heroImages[imgIndex]} alt="Cheston Security officer on duty"
                  className="w-full h-full object-cover transition-opacity duration-700"
                  style={{ objectPosition: imgIndex === 0 ? "50% 25%" : imgIndex === 1 ? "50% 8%" : "30% 30%" }} />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to right, rgba(15,18,22,0.5), transparent 40%)" }} />
                <div key={scanKey} className="absolute inset-0 pointer-events-none overflow-hidden">
                  <div style={{
                    position: "absolute", top: 0, bottom: 0, width: "60px",
                    background: "linear-gradient(90deg, transparent, rgba(255,59,59,0.05) 20%, rgba(255,59,59,0.5) 48%, #ff5b5b 50%, rgba(255,59,59,0.5) 52%, rgba(255,59,59,0.05) 80%, transparent)",
                    animation: "scanLine 1.6s cubic-bezier(0.4,0,0.2,1)",
                    filter: "blur(0.5px)"
                  }} />
                </div>
                <div className="absolute top-2 right-2 flex items-center gap-1.5 px-2 py-1 rounded" style={{ background: "rgba(0,0,0,0.5)", backdropFilter: "blur(4px)" }}>
                  <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#c9973f", animation: "livePulse 1.5s ease-in-out infinite" }} />
                  <span className="text-[9px] font-bold tracking-widest text-white/90 uppercase">Live</span>
                </div>
              </div>
            </div>
          </div>

          {/* Framed portrait — desktop only */}
          <div className="animate-fadeIn delay-200 relative hidden lg:block">
            <div className="relative" style={{ padding: "10px", border: "1px solid rgba(201,151,63,0.35)" }}>
              <div className="relative overflow-hidden" style={{ aspectRatio: "3/4" }}>
                <img src={heroImages[imgIndex]} alt="Cheston Security officer on duty"
                  className="w-full h-full object-cover transition-opacity duration-700"
                  style={{ objectPosition: "60% 25%" }} />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(15,18,22,0.6), transparent 50%)" }} />
              </div>
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 px-4 py-1.5 text-[10px] font-bold tracking-[0.2em] uppercase whitespace-nowrap"
                style={{ background: "#c9973f", color: "#0f1216" }}>
                Approved to Protect
              </div>
            </div>
          </div>
      ...
      {/* Credentials strip */}
      <div className="relative z-10 border-t flex-shrink-0" style={{ borderColor: "rgba(201,151,63,0.2)", background: "rgba(0,0,0,0.25)" }}>
        <div className="max-w-6xl mx-auto px-6 sm:px-10 py-3 sm:py-5 grid grid-cols-3 gap-4">
          {[
            { icon: Activity, val: "24/7", label: "Control Room" },
            { icon: Users, val: "300+", label: "Trained Officers" },
            { icon: Shield, val: "200+", label: "Clients Protected" },
          ].map((s, i) => (
            <div key={s.label} className="flex items-center gap-2 sm:gap-3"
              style={{ borderRight: i < 2 ? "1px solid rgba(255,255,255,0.1)" : "none" }}>
              <s.icon className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" style={{ color: "#c9973f" }} />
              <div>
                <div className="text-base sm:text-xl font-bold text-white leading-none">{s.val}</div>
                <div className="text-white/45 text-[9px] sm:text-xs font-medium tracking-wide uppercase mt-0.5">{s.label}</div>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl relative" style={{ aspectRatio: "5/4" }}>
              <img src="/about-main.jpg"
                alt="John Kamau — K9 Unit Officer" className="w-full h-full object-cover object-top cursor-pointer"
                onClick={() => setSelected({src:"/about-main.jpg",caption:"CHESTON Security Team"})}
        ...
        <Reveal delay={0.15}>
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              CHESTON security solutions limited is a Kenyan company dedicated to the provision of excellent security services. We are capable of dealing with all your security needs and offer a complete range of planning, system analysis and design as well as executive services.
            </p>
            <p className="text-gray-500 leading-relaxed mb-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-white/70 leading-relaxed">
                At Cheston Security Services Limited, we believe good security starts with good people. Our officers are carefully selected, properly trained, and supervised closely so that every deployment meets the standard our clients expect.
              </p>
              <p className="text-white/70 leading-relaxed">
                We work across residential, corporate, and industrial sites, tailoring each security plan to the specific risks and needs of the property. No two clients are the same, and we don't believe in one-size-fits-all solutions.
              </p>
              <p className="text-white/70 leading-relaxed">
                Integrity guides how we run this company — from how we treat our staff to how we deliver on our contracts. We're building Cheston to be a company our clients and our team can rely on for the long term.
              </p>
              <div className="pt-4 border-t border-white/10 flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <div className="text-red-400 text-sm font-medium">Director</div>
                  <div className="text-red-400 text-sm font-medium">Cheston Security Services Limited</div>
                </div>
        ...
        <Reveal delay={0.12}>
          <div className="mb-16 rounded-3xl overflow-hidden relative shadow-xl" style={{ minHeight: "220px" }}>
            <img src="/mission-team.jpg"
              alt="CHESTON Security Mission Team" className="w-full h-full object-cover absolute inset-0" style={{ height: "100%" }}
            ...
            <div className="relative z-10 p-10 md:p-14" style={{ background: "linear-gradient(135deg,rgba(220,38,38,0.88),rgba(30,58,138,0.82))" }}>
              ...
              <p className="text-white/90 text-lg leading-relaxed mb-3 max-w-3xl">
                CHESTON Security is committed to providing exceptional services by delivering personalized, high-quality and cost efficient solutions to meet the needs of our clients.
              </p>
        ...
        <Reveal delay={0.14}>
          <div className="mb-16 grid md:grid-cols-3 gap-6 p-8 rounded-3xl" style={{ background: "linear-gradient(135deg,#0f172a,#1e1b4b)" }}>
            <div className="md:col-span-3 mb-4">
              <h3 className="text-xl font-bold text-white">Why Choose CHESTON?</h3>
              <p className="text-white/50 text-sm mt-1">Since inception, CHESTON Security has delivered a wide range of security services. Our security packages are designed to cater for clients with respect to their specific needs and financial capabilities.</p>
            </div>
            {[
...
export const services = [
  {
    ...
    desc: "For several years, CHESTON Security has delivered superior guarding services. We value long-term relationships and take time to understand your needs and environment with a full risk assessment. Officers are uniformed, well equipped, and carry panic buttons linked to our control room.",
  ...
  },
  {
    ...
    desc: "CHESTON Security incorporates monitoring solutions designed to fit any and all of your security needs. Our monitoring packages will bring you peace of mind knowing that your property is protected by a state of the art system installed by trained certified technicians.",
  ...
  },
  {
    ...
    desc: "To ensure that guards complete their duties accordingly and in accordance with company policy and the clients instructions, CHESTON Security has Area Managers and Supervisors who will constantly check on the guards.",
        ...
        <Reveal delay={0.2}>
          <div className="rounded-3xl overflow-hidden relative shadow-xl" style={{ height: "280px" }}>
            <img src="/supervision-truck.jpg"
              alt="CHESTON Security patrol vehicle" className="w-full h-full object-cover"
              onError={e => { e.target.style.background="#0f172a"; }} />
  ...
  return (
    <section id="contact" className="overflow-hidden">
      <div className="relative h-64 md:h-80">
        <img src="/contact-officer.jpg" alt="Contact CHESTON Security"
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <Reveal delay={0.15} className="lg:col-span-2 space-y-4">
              ...
              <div className="rounded-3xl p-5 relative overflow-hidden" style={{ background: "linear-gradient(135deg,#dc2626,#991b1b)" }}>
                ...
                <a href="tel:+254702396783" className="text-3xl font-black text-white hover:opacity-80 transition-opacity block">0702 396 783</a>
              ...
              <div className="rounded-3xl p-5 bg-white border border-gray-100 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://vm.tiktok.com/ZS9h9STC22VpQ-Fd32a/" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
                    style={{ background: "#010101", border: "1px solid #333" }} title="TikTok">
                    <svg viewBox="0 0 24 24" fill="white" width="18" height="18">
                      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z"/>
                    </svg>
                  </a>
                  <a href="https://wa.me/254783046972" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
    ...
    <footer style={{ background: "#0f172a" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-4 pb-8">
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">© {new Date().getFullYear()} CHESTON security solutions limited. All rights reserved.</p>
          <div className="flex items-center gap-3">
